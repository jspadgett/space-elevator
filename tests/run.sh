...
# ── Handheld: Big Picture on, TLP off even when asked for ────────────
# CI hardware never matches the DMI table, so this exercises the
# SE_HANDHELD override, which is the same path a script takes.
